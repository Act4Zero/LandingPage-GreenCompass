...
function Navbar(props) {
  ...
  const classes = {
    navLink:
      "font-semibold inline-flex items-center space-x-1 h-8 px-4 py-6 group-hover:text-green-dark transition duration-200",
    navLinkIcon:
    ...
    accountDropdown: {
      inner:
        "bg-white ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100 shadow-xl",
    ...
    <Section bgColor="bg-white">
      <div className="container py-4">
        <div className="flex justify-between">
          <Link href="/">
            <a className="inline-flex items-center space-x-2 font-bold text-lg tracking-wide text-green-dark hover:text-green">
              <Image
        ...
        <div className={"lg:hidden" + (!mobileNavOpen ? " hidden" : "")}>
          <div className="grid grid-cols-1 sm:grid-cols-3 border rounded-xl my-5 bg-green-lightest">
